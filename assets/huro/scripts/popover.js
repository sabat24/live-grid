...
$(document).ready((function () {
    $('*[data-toggle="popover"]').each((function () {
        var a = $(this).attr("data-pop-mode"), n = $(this).attr("data-pop-title"), s = $(this).attr("data-pop-content"),
            i = $(this).attr("data-pop-position"), o = $(this).attr("data-pop-width"),
            e = $(this).attr("data-pop-avatar"), t = $(this).attr("data-pop-icon"), p = $(this).attr("data-pop-iconbg"),
            r = "", l = "";
        ...
        var a = $(this), n = $(this).attr("data-user-popover"), s = feather.icons.mail.toSvg(),
            i = feather.icons.phone.toSvg(), o = feather.icons["more-horizontal"].toSvg();
        $.ajax({
            url: "assets/data/user.json", dataType: "json", success: function (e) {
                a.webuiPopover({
                    trigger: "hover",
                    placement: "auto",
                    width: 300,
